...
import dev.sun.wechat.agent.engine.ToolExecutionContext
import dev.sun.wechat.agent.model.LlmToolCall
import dev.sun.wechat.agent.tool.ToolCallOrigin
...
class ToolBridgeSession(
    ...
    data class AuditEntry(
        ...
        val approvalStatus: dev.sun.wechat.agent.data.entity.ApprovalStatus?,
