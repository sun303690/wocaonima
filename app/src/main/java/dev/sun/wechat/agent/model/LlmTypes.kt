...
/**
 * API-agnostic conversation types consumed by the [dev.sun.wechat.agent.engine] loop. The
 ...
 * [dev.sun.wechat.agent.engine.AgentSessionEngine.runTurn] tool loop and is **not** persisted —
