package dev.sun.wechat.agent.trigger
 ...
 *
 * These enums are stored by Room (by name, via [dev.sun.wechat.agent.data.WeAgentConverters]) and
...
data class TriggerConditions(
    ...
    /** Allowed message `type` codes (see [dev.sun.wechat.features.api.core.models.MessageType]); null/empty = any. */
