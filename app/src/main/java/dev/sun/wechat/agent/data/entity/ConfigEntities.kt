package dev.sun.wechat.agent.data.entity
 ...
 * [dev.sun.wechat.agent.data.WeAgentRepository.upsertModelProvider] for why.
 */
...
data class ModelEntity(
     ...
     * into [dev.sun.wechat.agent.tool.ToolVisibility.visionTools], so concurrent sessions on
 ...
 * Keys are stored as-is; see [dev.sun.wechat.agent.net.ExternalServiceId] for known ids.
 */
