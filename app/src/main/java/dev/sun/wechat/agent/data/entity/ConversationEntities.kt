...
data class SessionEntity(
    ...
    /**
     * Bound model id, or null for "默认" — meaning follow [dev.sun.wechat.agent.data.WeAgentSettings.defaultModelId] resolved
     ...
     * [dev.sun.wechat.agent.data.WeAgentSettings.defaultPermissionLevel] resolved at call time.
