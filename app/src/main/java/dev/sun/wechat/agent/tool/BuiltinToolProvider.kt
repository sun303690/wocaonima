package dev.sun.wechat.agent.tool

import dev.sun.wechat.agent.tool.BuiltinToolProvider.Companion.AVAILABILITY_CHECKS
import dev.sun.wechat.agent.tool.BuiltinToolProvider.Companion.exaKeyPresent
...
class BuiltinToolProvider(
     ...
     * [dev.sun.wechat.agent.tool.ToolRegistry.resolveVisibleTools] from the turn's
