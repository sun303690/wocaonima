package dev.sun.wechat.agent.ui
 ...
 *
 * Installed by [dev.sun.wechat.features.api.agent.WeAgentService] around
 * [dev.sun.wechat.agent.engine.AgentSessionEngine.runTurn]. Screenshots are intentionally NOT persisted to
