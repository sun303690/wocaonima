...
import dev.sun.wechat.ui.utils.theme.ThemeSettings.applyToWechat
import dev.sun.wechat.ui.utils.theme.ThemeSettings.colorSpec
import dev.sun.wechat.ui.utils.theme.ThemeSettings.dynamicWallpaper
import dev.sun.wechat.ui.utils.theme.ThemeSettings.paletteStyle
import dev.sun.wechat.ui.utils.theme.ThemeSettings.seedColor
 ...
 * - the UI injected into WeChat ([InjectedUiTheme]) + native recoloring ([dev.sun.wechat.features.items.beautify.MonetEngine]) only
...
object ThemeSettings {
     ...
     * recoloring via [dev.sun.wechat.features.items.beautify.MonetEngine]). Does NOT take effect live — requires restarting WeChat.
     */
