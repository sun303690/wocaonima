 ...
 *
 * `dev.sun.wechat.agent.trigger.TriggerScheduler` sleeps in-process on purpose (its triggers are
...
object HideContactsSchedule {
     ...
     */
    private const val ACTION_FIRE = "dev.sun.wechat.action.HIDE_CONTACTS_SCHEDULE"
