...
import dev.sun.wechat.agent.jvm.JvmValueBridge
import dev.sun.wechat.agent.model.LlmImage
import dev.sun.wechat.agent.ui.UiAutomator
import dev.sun.wechat.agent.ui.UiImageSink
import dev.sun.wechat.features.core.AgentTool
import dev.sun.wechat.features.core.AgentTool.Companion.BUILTIN_UI
import dev.sun.wechat.features.core.AgentToolParam
...
object WeUiAutomationToolBindings {
    ...
    fun uiInputText(
        ...
        JvmValueBridge.onMain {
            val act = dev.sun.wechat.utils.android.getTopMostActivity()
                ?: throw dev.sun.wechat.agent.jvm.JvmBridgeException("No top-most activity")
            val focused = act.currentFocus
                ?: throw dev.sun.wechat.agent.jvm.JvmBridgeException("No focused view")
