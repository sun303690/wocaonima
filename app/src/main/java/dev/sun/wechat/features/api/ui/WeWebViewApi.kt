...
import dev.sun.wechat.features.api.ui.WeWebViewApi.evaluateJavascript
import dev.sun.wechat.features.api.ui.WeWebViewApi.loadUrl
import dev.sun.wechat.features.api.ui.WeWebViewApi.reload
import dev.sun.wechat.features.api.ui.WeWebViewApi.tracked
 ...
 * 方法名调用，同时适配二者（与 [dev.sun.wechat.features.items.miniapps.ErudaConsole] 的做法一致）。
 */
