...
import dev.sun.wechat.features.items.system.servers.WeChatService.Result

/**
 * The built-in WeAgent tool surface. Every `@AgentTool` function here is discovered by the
 * [dev.sun.wechat.features.AgentToolScanner] KSP processor and registered in the generated
