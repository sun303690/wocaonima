...
import dev.sun.wechat.agent.trigger.MessageDirection
import dev.sun.wechat.agent.trigger.ScheduleKind
import dev.sun.wechat.agent.trigger.SqlOp
import dev.sun.wechat.agent.trigger.TriggerConditions
import dev.sun.wechat.agent.trigger.TriggerConditionsJson
import dev.sun.wechat.agent.trigger.TriggerScope
import dev.sun.wechat.agent.trigger.TriggerType
