...
import dev.sun.wechat.ui.utils.theme.ModuleAppTheme
import dev.sun.wechat.utils.WeLogger
import dev.sun.wechat.utils.android.androidUserId
import dev.sun.wechat.utils.android.getEnabled
import dev.sun.wechat.utils.android.setEnabled
import dev.sun.wechat.utils.android.showToast
import dev.sun.wechat.utils.formatEpoch
import dev.sun.wechat.utils.hook_status.HookStatus
        ...
        Scaffold(
            ...
            Column(
                ...
                ElevatedCard(
                    onClick = {
                        val hostPkg =
                            prefs.getString("host_pkg_name", PackageNames.WECHAT)!!
                        try {
                            startActivity(dev.sun.wechat.utils.android.Intent {
                ...
                LinkCard(
                    ...
                    subtitle = "https://t.me/+bcdb3j7qPgw0NDE9",
                    onClick = { onUrlClick("https://t.me/+bcdb3j7qPgw0NDE9") }
                )
            }
