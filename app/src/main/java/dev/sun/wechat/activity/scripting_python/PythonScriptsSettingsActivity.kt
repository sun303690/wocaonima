...
package dev.sun.wechat.activity.scripting_python
...
import dev.sun.wechat.extensions.ExtensionPackDialogs
import dev.sun.wechat.extensions.PythonRuntimePack
import dev.sun.wechat.features.items.scripting_python.plugin.PythonPluginManager
import dev.sun.wechat.features.items.scripting_python.plugin.PythonPluginManifest
import dev.sun.wechat.features.items.scripting_python.plugin.PythonPluginRecord
import dev.sun.wechat.features.items.scripting_python.plugin.PythonPluginStatus
import dev.sun.wechat.features.items.scripting_python.plugin.PythonCrashGuard
import dev.sun.wechat.features.items.scripting_python.runtime.PythonRuntimeLoader
...
import dev.sun.wechat.ui.agent.settings.rememberCreationBackGuard
...
import dev.sun.wechat.ui.content.m3AppBarBlur
import dev.sun.wechat.ui.content.m3AppBarColor
import dev.sun.wechat.ui.content.m3BackdropLayer
import dev.sun.wechat.ui.content.rememberMaterial3BlurBackdrop
 ...
 * [dev.sun.wechat.ui.agent.settings.ModelProviderDetailScreen]: draft fields + one save action
