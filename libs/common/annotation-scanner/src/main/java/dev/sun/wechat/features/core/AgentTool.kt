...
/**
 * Marks a function as a WeAgent built-in tool. The [dev.sun.wechat.features.AgentToolScanner] KSP processor
 ...
 * so no hand-written mapping table is needed and new [dev.sun.wechat] APIs are picked up
